        ...
        while (!terminate) {
            ...
            do {
                ...
                try {
                    ...
                    retry = false; //aggiunto perché se inserissi come input 0 retry resta true anche se il successivo input viene accettato
            ...
            do {
                ...
                try {
                    ...
                    retry = false; //aggiunto perché inserendo un valore errato di b e poi reinserendo il valore giusto retry restava true
                } catch (IOException e) {
                    System.err.println("Errore di Input/Output!");
                    System.exit(1);
                } catch (NumberFormatException e) {
            ...
            do {
                ...
                try {
                    ...
                    retry = false; //aggiunto perché inserendo un valore errato di c e poi reinserendone uno corretto retry rimaneva true e andava in loop
                } catch (IOException e) {
                    System.err.println("Errore di Input/Output!");
                    System.exit(1);
                } catch (NumberFormatException e) {
