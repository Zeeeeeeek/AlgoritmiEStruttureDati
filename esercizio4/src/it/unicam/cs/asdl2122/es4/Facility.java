...
public abstract class Facility {
    ...
    public Facility(String codice, String descrizione) {
        if(codice == null || descrizione == null) throw new NullPointerException("Il codice o la descrizione sono" +
                "null");
        this.codice = codice;
    ...
    @Override
    public int hashCode() {
        int hash = 31 * 17 + codice.hashCode();
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        Facility temp = (Facility) obj;
        return codice.equals(temp.codice);
    }
